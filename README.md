...
**v1.72.2** (`PBL1/js/constants.js`의 `APP_VERSION`)
...
## 브랜치 동기화 (main · v1.72.2)

업데이트 후 아래처럼 `main`과 `v1.72.2` 브랜치를 맞춥니다.

```bash
git add .
git commit -m "업데이트 내용"
git push origin main
git push origin main:v1.72.2
```

`v1.72.2` 브랜치가 아직 없으면 위 `git push origin main:v1.72.2` 한 번으로 생성됩니다.
...
- **Branch**: `main` (또는 `v1.72.2`) / **Folder**: `/ (root)`
